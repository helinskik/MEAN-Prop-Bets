...
class BetsRepository {
    ...
    getBetsSummary(skip, top, callback) {
        ...
        Bet.count((err, custsCount) => {
            ...
            Bet.find({}, { '_id': 0, 'firstName': 1, 'lastName': 1, 'city': 1, 'state': 1, 'orderCount': 1, 'gender': 1 })
                    .skip(skip)
                    .limit(top)
    ...
    updateBet(id, body, callback) {
        ...
        if(body.playerId == 0 && body.groupId == 0) {
            Bet.update({"eventId": body.eventId, "question": body.question, "answer": ""}, {"$set":{"answer": body.answer}}, {"multi": true}, (err, callback) => {
            ...
            Bet.findById(id, (err, bet)  => {
                ...
                bet.groupId = groupId || bet.groupId;
